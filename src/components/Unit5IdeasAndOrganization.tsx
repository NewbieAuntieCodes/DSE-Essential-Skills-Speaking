...
const Unit5IdeasAndOrganization: React.FC<{ onBack: () => void }> = ({ onBack }) => {
    ...
    return (
        <IdeasContainer>
            ...
            <Section>
                <h3>Finding ideas in the story</h3>
                <p>In the exam, you might talk about the good and bad parts of an idea. Sometimes, looking at the different points in the story can help you find ideas.</p>
                <p>Look at the Exam practice below.</p>
                <InstructionBox>
